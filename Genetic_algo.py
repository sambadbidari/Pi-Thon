...
def main():
    ...
    for i in range(no_of_generations):
        ...
        pholder = print_top_5(snakes[0:5])
        pholder = float(pholder)
        score_array.append(pholder)
        gen_array.append(i+1)
    ...
    ploot.plut(gen_array, score_array)
